...
You have to have a Makefile in your project directory that will compile ft_printf.a as the default make option, and your ft_printf.a has to have ft\_printf inside.
...
### If your libft.a is separate from ft_printf.a
If you include all required .o files (including your libft) in ft_printf.a, this is not necessary. If you do NOT, and require your libft separate, you must set `USE_SEPARATE_LIBFT=1` in options-config.ini, and make sure the path is correct. See options-config.ini, and it should be self-explanatory.
